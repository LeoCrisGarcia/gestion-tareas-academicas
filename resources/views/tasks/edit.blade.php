...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-primary">Editar tarea</h1>
    </div>
                ...
                <form method="POST" action="{{ route('tasks.update', $task) }}">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="description" rows="3"
                                class="input-theme w-full rounded-[var(--radius-input)] px-4 py-2.5 text-sm">{{ old('description', $task->description) }}</textarea>
                    </div>
                    ...
                    <div class="mb-8">
                        <label class="block text-sm font-medium text-secondary/70 mb-1.5">Estado</label>
                        <select name="status" class="input-theme w-full rounded-[var(--radius-input)] px-4 py-2.5 text-sm">
