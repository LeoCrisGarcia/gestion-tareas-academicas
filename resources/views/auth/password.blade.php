            ...
            <div class="relative z-10">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="mb-5">
                        ...
                        @error('current_password') <p class="text-secondary/60 text-sm mt-1">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="password" name="password"
                               class="input-theme w-full rounded-[var(--radius-input)] px-4 py-2.5 text-sm">
                        @error('password') <p class="text-secondary/60 text-sm mt-1">{{ $message }}</p> @enderror
                    </div>
